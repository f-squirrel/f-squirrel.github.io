...
published: true
permalink: "/deep-dive-into-std-abort"
share-img: /img/docker-logo-696x364.png
tags: [docker, libc, linux, signals, sigsegv, sigabrt, c, kernel, init]
readtime: true
---

In my previous [post](/how-to-contain-a-crashed-container/), I provided insight on the importantance of running docker with the
...
the `--init` flag, it had the PID 1 in the container's [PID
...
It then makes a last attempt to send the signal:
