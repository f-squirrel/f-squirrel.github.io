...
If you work with private keys — and in an MPC wallet, that's most of the job — you've probably written this happy little line and felt good about it:
...
It's pure Rust, `no_std`, no allocator, and it works on arrays, `Vec`, `String`, and your own types via `#[derive(Zeroize)]`. After it runs, the bytes *at that spot* really are zero, and the compiler can't undo it. Lovely.
