...
You can't name slot A in Rust anymore, but the bytes are still there for anything that can read your process's memory — a debugger, a core dump, or the OS paging to swap.
